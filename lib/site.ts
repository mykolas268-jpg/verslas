...
export const siteConfig = {
  ...
  /** Footer-only links (policies). */
  legalNav: [
    { href: '/kaip-rengiame-straipsnius', label: 'Kaip rengiame straipsnius' },
  ...
  publisher: {
    ...
    /** Person with editorial responsibility (EU AI Act Art. 50(4)). */
    editor: 'Mykolas Gustas',
